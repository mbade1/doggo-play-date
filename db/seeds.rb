...
comment_1 = Comment.create(comment: "Wow! What a beautiful park!", park_id: 1, user_id: 1 )
comment_2 = Comment.create(comment: "I love this park!", park_id: 1, user_id: 1)
comment_3 = Comment.create(comment: "Waste of time.", park_id: 1, user_id: 2)
comment_4 = Comment.create(comment: "Ever since they got rid of free snowcones, I've stopped going here.", park_id: 1, user_id: 2)
comment_5 = Comment.create(comment: "The government is listening in this park.", park_id: 1, user_id: 3)
comment_6 = Comment.create(comment: "My dogs ears can hear the government.", park_id: 1, user_id: 3)
